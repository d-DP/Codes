...
\begin{figure}[!ht]
\resizebox{.4\linewidth}{!}{\input{tri_ex}}
...
\textbf{Solution:}
\begin{figure}[!ht]
\resizebox{0.3\linewidth}{!}{\input{tri_constr1}}
\caption{Triangle}
\label{fig:foo}
\end{figure}
Apply cosine rule \\
...
\textbf{Solution:}
\begin{figure}[!h]
\resizebox{0.3\linewidth}{!}{\input{parallelogram}}
\caption{Rhombus}
\label{fig:foo}
\end{figure}
...
\textbf{Solution:}
\begin{figure}[!ht]
\resizebox{0.2\linewidth}{!}{\input{circle_exer}}
\caption{Circle}
...
\begin{figure}[!ht]
\resizebox{0.45\linewidth}{!}{\input{circle_constr}}
\caption{Circle}
\label{fig:foo}
\end{figure}
\end{frame}
...
\textbf{Solution:} 
\begin{figure}[!ht]
\resizebox{0.45\linewidth}{!}{\input{misc}}
\caption{Circle}
\label{fig:foo}
\end{figure}
\end{frame}
